...
def parse_nuclei_output(raw_output: str, target_url: str = '') -> list:
    results = []
...
def parse_dalfox_output(raw_output: str, target_url: str = '') -> list:
    results = []
    for line in raw_output.strip().split("\n"):
        line = line.strip()
        if not line:
...
def parse_ffuf_output(raw_output: str, target_url: str = '') -> list:
    results = []
    for line in raw_output.strip().split("\n"):
        line = line.strip()
